...
<head>
    ...
    <title>Accueil - Gestion Vente</title>
...
<body>
    ...
    <section class="welcome">
        ...
        <p>Votre solution efficace pour gérer les achats, les clients, les employés et les factures.</p>
        <p>Utilisez le menu ci-dessus pour naviguer vers différentes sections.</p>
    </section>
